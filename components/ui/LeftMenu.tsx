            ...
            <div className='flex w-full' style={{ height: 'calc(100vh - 49px' }}>
              <div className={`w-[250px] z-40 bg-white border-r pt-6 pb-6 pl-4 pr-4 flex flex-col justify-between dark:border-neutral-800 dark:bg-neutral-900`}>
                <div className='flex flex-col gap-2'>
                  ...
                  <Link href='/mensajes' onClick={() => setMessages(false)} className={`transition-all duration-150 ${pathname.includes('/mensajes') ? 'bg-main/20' : ''} flex h-8 gap-2 pt-1 pb-1 pl-2 pr-2 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800`}><AiOutlineMessage className='mt-auto mb-auto text-xl text-main' /><p>Mensajes</p>{messages ? <div className='bg-main h-3 w-3 my-auto ml-auto rounded-full' /> : ''}</Link>
